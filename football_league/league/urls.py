...
urlpatterns = [
    ...
    path('players/add/', views.add_player_view, name='add-player'),
    path('players/add/contracted/', views.PlayerListView.as_view(), name='add-contracted-player'),
    path('players/add/free-agent/', views.PlayerListView.as_view(), name='add-free-agent'),
    ...
    path('transfers/<int:sender_id>/<int:receiver_id>/<int:player_id>/accept/', 
         views.TransferAcceptView.as_view(), name='transfer-accept'),
    ...
    path('matches/<int:home_id>/<int:away_id>/result/', 
         views.RecordMatchResultView.as_view(), name='record-match-result'),
    ...
    path('auctions/<int:player_id>/<int:club_id>/complete/', 
         views.CompleteAuctionView.as_view(), name='complete-auction'),
    path('auctions/<int:player_id>/cancel/', 
         views.CancelAuctionView.as_view(), name='cancel-auction'),
]