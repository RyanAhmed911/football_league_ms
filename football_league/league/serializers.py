...
class NewPlayerSerializer(serializers.Serializer):
    name = serializers.CharField(max_length=100)
    ...
    playerType = serializers.CharField(max_length=20)  # 'contracted' or 'free_agent'
    club_id = serializers.IntegerField(required=False, allow_null=True)
    squad_id = serializers.IntegerField(required=False, allow_null=True)
